...
public class SandboxConjuntos
{
    ...
    {
        java.util.List<String> r = new java.util.ArrayList<String>(arbolCadenas.size());
        for (String s : arbolCadenas) r.add(s);
        return r;
    }
    ...
    {
        java.util.List<String> r = new java.util.ArrayList<String>(arbolCadenas.size());
        for (String s : arbolCadenas.descendingSet()) r.add(s);
        return r;
    }
    ...
    {
    	if (cadena != null) arbolCadenas.add(cadena);
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        {
            if (s != null && s.equalsIgnoreCase(cadena)) { objetivo = s; break; }
        }
        if (objetivo != null) arbolCadenas.remove(objetivo);
    ...
    {
    	java.util.NavigableSet<String> nuevo = new java.util.TreeSet<String>();
    ...
    {
    	java.util.TreeSet<String> invertido = new java.util.TreeSet<String>(java.util.Collections.reverseOrder());
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        ...
        for (String s : otroArreglo) if (!arbolCadenas.contains(s)) return false;
        return true;
    }
